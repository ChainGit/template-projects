package com.jycar.server.common.utils;
...
public class JyComUtils {
    ...
    public static <T> T mapToObject(Map<String, Object> map, Class<T> beanClass) {
        ...
        try {
            ...
            throw new CarServerRuntimeException("map to object", e);
        }
    }
    ...
    public static Map<String, Object> objectToMap(Object obj) {
        ...
        try {
            ...
            throw new CarServerRuntimeException("object to map", e);
        }
    }
    ...
    public static void randomDisaster() {
        ...
        if (r % 4 == 0) {
            ...
            throw new CarServerRuntimeException("==== dont't worry, just a random disaster ====");
        }
    }
}
